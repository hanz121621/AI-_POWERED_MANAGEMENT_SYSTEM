...
namespace AI_PMS.Application.Services.Teams
{
    public class TeamService : ITeamService
    {
                ...
                Guid userId)
        {
            ...
            // =====================================================
            // GET ACTIVE TEAM IDS FOR USER
            // =====================================================

            var teamIds =
                await _teamRepository
                    .GetActiveTeamIdsByUserIdAsync(userId);
