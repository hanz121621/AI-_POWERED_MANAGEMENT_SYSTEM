...
namespace AI_PMS.Infrastructure.Migrations
{
    ...
    [Migration("20260822150702_InitialUserSystem")]
    partial class InitialUserSystem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AI_PMS.Domain.Entities.Teams.TeamMember", b =>
                {
                    ...
                    b.Property<Guid?>("ContributorSubTypeId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ContributorSubTypeId1");
            ...
            modelBuilder.Entity("AI_PMS.Domain.Entities.Teams.TeamMember", b =>
                {
                    ...
                    b.HasOne("AI_PMS.Domain.Entities.Teams.ContributorSubType", null)
                        .WithMany("TeamMembers")
                        .HasForeignKey("ContributorSubTypeId1");
